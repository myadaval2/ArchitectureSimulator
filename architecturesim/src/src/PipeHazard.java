...
public class PipeHazard {
    ...
    private String EX_MEM_RegisterRd;
    private String MEM_WB_RegisterRd;
    private String ID_EX_RegisterRs;
    private String ID_EX_RegisterRt;
    ...
    public PipeHazard() {
        ...
        this.EX_MEM_RegisterRd = "";
        this.MEM_WB_RegisterRd = "";
        this.ID_EX_RegisterRs = "";
        this.ID_EX_RegisterRt = "";
        this.ALUOutput = 0;
        this.memoryOutput = 0;
    }
     ...
     */
    public String getEX_MEM_RegisterRd() {
     ...
     */
    public void setEX_MEM_RegisterRd(String EX_MEM_RegisterRd) {
     ...
     */
    public String getMEM_WB_RegisterRd() {
     ...
     */
    public void setMEM_WB_RegisterRd(String MEM_WB_RegisterRd) {
     ...
     */
    public String getID_EX_RegisterRs() {
     ...
     */
    public void setID_EX_RegisterRs(String ID_EX_RegisterRs) {
     ...
     */
    public String getID_EX_RegisterRt() {
     ...
     */
    public void setID_EX_RegisterRt(String ID_EX_RegisterRt) {
