...
//        clockTextBox.setText(Integer.toString(cpu.getClock()));
    ...
    private void AddressRangeDropDownActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddressRangeDropDownActionPerformed
        ...
        if (null != (String) CacheLevelNameDropDown.getSelectedItem()) switch ((String) CacheLevelNameDropDown.getSelectedItem()) {
            case "DRAM":
            memoryArraySegment = dm.getMemoryPage("DRAM", d.memoryEnabled.DRAM.getMemArray(), d.memoryEnabled.DRAM.getTagArray(), memoryPage);
            MemoryViewer.setModel(new javax.swing.table.DefaultTableModel(
                memoryArraySegment,
                columnNames
            )
        ...
        case "L2 Cache":
        memoryArraySegment = dm.getMemoryPage("L2Cache", d.memoryEnabled.L2Cache.getMemArray(), d.memoryEnabled.L2Cache.getTagArray(), memoryPage);
        MemoryViewer.setModel(new javax.swing.table.DefaultTableModel(
            memoryArraySegment,
            columnNames
        )
        ...
        case "L1 Cache":
        memoryArraySegment = dm.getMemoryPage("L1Cache", d.memoryEnabled.L1Cache.getMemArray(), d.memoryEnabled.L1Cache.getTagArray(), memoryPage);
        MemoryViewer.setModel(new javax.swing.table.DefaultTableModel(
            memoryArraySegment,
            columnNames
        )
